        ...
        describe("書籍作成") {
            ...
            context("書籍タイトルが空白の場合") {
                it("InvalidBookException を投げる") {
                    ...
                    val exception =
                        shouldThrow<InvalidBookException> {
            ...
            context("著者IDが空の場合") {
                it("AuthorIdsRequiredException を投げる") {
                    ...
                    val exception =
                        shouldThrow<AuthorIdsRequiredException> {
            ...
            context("存在しない著者IDが含まれる場合") {
                it("BookAuthorNotFoundException を投げる") {
                    val repository = mockk<BookRepository>()
                    val service = BookService(repository)
                    every { repository.findAuthorsByIds(listOf(1, 999)) } returns
                        listOf(
                            Author(
                                id = 1,
                                name = "夏目漱石",
                    ...
                    val exception =
                        shouldThrow<BookAuthorNotFoundException> {
