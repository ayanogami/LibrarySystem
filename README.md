...
SpringDocでOpenAPIを自動生成します。アプリ起動後、以下のURLでAPI仕様を確認できます。

- Swagger UI: http://localhost:8080/swagger-ui/index.html
- OpenAPI JSON: http://localhost:8080/v3/api-docs

Controller、request / response DTOにOpenAPI用のアノテーションを付けているため、エンドポイント、request body、response body、エラーレスポンスの型をSwagger UI上で確認できます。
